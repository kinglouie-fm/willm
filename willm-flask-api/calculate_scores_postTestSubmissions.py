...
def process_user_data(user_data):
    ...
    for submission in user_data.get('postTestSubmissions', []):
        ...
        user_results[submission['_id']['$oid']] = median_scores
...
input_json_file = '/Users/benthillen/Downloads/mongo/backup-google/willm/users.json'
output_json_file = os.path.join(os.path.join(os.path.dirname(__file__), 'evaluation/scores/'), 'user_scores.json')
