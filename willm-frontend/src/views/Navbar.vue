...
const updateLLM = async (modelKey, value) => {
    ...
    try {
        await axios.patch('http://34.46.136.120:3101/user/updateModel', {
            [modelKey]: newValue,
        });
...
const updateLanguage = async () => {
    try {
        await axios.patch('http://34.46.136.120:3101/user/updateLanguage', {
...
const checkQuiz = async () => {
    try {
        const response = await axios.get('http://34.46.136.120:3101/quiz/check-quiz');
