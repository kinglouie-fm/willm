...
const updateLLM = async (modelKey, value) => {
    ...
    try {
        await axios.patch('https://willm.corinth.informatik.rwth-aachen.de:3101/user/updateModel', {
            [modelKey]: newValue,
        });
...
const updateLanguage = async () => {
    try {
        await axios.patch('https://willm.corinth.informatik.rwth-aachen.de:3101/user/updateLanguage', {
...
const checkQuiz = async () => {
    try {
        const response = await axios.get('https://willm.corinth.informatik.rwth-aachen.de:3101/quiz/check-quiz');
