...
const updateLLM = async (modelKey, value) => {
    ...
    try {
        await axios.patch('http://academic-willm.de/user/updateModel', {
            [modelKey]: newValue,
        });
...
const updateLanguage = async () => {
    try {
        await axios.patch('http://academic-willm.de/user/updateLanguage', {
...
const checkQuiz = async () => {
    try {
        const response = await axios.get('http://academic-willm.de/quiz/check-quiz');
