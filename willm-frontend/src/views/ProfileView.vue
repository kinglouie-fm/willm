...
const getSections = async () => {
    try {
        const response = await axios.get('https://willm.corinth.informatik.rwth-aachen.de:3101/score/sections');
...
const fetchComparison = async () => {
    if (selectedSection.value) {
        try {
            const response = await axios.get(`https://willm.corinth.informatik.rwth-aachen.de:3101/score/comparison/${selectedSection.value}`, { withCredentials: true });
...
const fetchGamification = async () => {
    try {
        const response = await axios.get('https://willm.corinth.informatik.rwth-aachen.de:3101/user/gamification', { withCredentials: true });
