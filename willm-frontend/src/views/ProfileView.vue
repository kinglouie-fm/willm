...
const getSections = async () => {
    try {
        const response = await axios.get('https://academic-willm.de/score/sections');
...
const fetchComparison = async () => {
    if (selectedSection.value) {
        try {
            const response = await axios.get(`https://academic-willm.de/score/comparison/${selectedSection.value}`, { withCredentials: true });
...
const fetchGamification = async () => {
    try {
        const response = await axios.get('https://academic-willm.de/user/gamification', { withCredentials: true });
