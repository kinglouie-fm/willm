...
const getSections = async () => {
    try {
        const response = await axios.get('http://34.71.205.236:3000/score/sections');
...
const fetchComparison = async () => {
    if (selectedSection.value) {
        try {
            const response = await axios.get(`http://34.71.205.236:3000/score/comparison/${selectedSection.value}`, { withCredentials: true });
...
const fetchGamification = async () => {
    try {
        const response = await axios.get('http://34.71.205.236:3000/user/gamification', { withCredentials: true });
