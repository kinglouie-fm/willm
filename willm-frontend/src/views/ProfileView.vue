...
const getSections = async () => {
    try {
        const response = await axios.get('http://willm.corinth.informatik.rwth-aachen.de/score/sections');
...
const fetchComparison = async () => {
    if (selectedSection.value) {
        try {
            const response = await axios.get(`http://willm.corinth.informatik.rwth-aachen.de/score/comparison/${selectedSection.value}`, { withCredentials: true });
...
const fetchGamification = async () => {
    try {
        const response = await axios.get('http://willm.corinth.informatik.rwth-aachen.de/user/gamification', { withCredentials: true });
