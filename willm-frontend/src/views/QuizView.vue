...
const fetchQuiz = async () => {
    try {
        const response = await axios.get('http://academic-willm.de/quiz/get-todays-quiz');
...
const submitAnswer = async (selectedAnswer = null, option) => {
    ...
    try {
        ...
        const response = await axios.post('http://academic-willm.de/quiz/submit-answer', {
...
const requestExplanation = async () => {
    try {
        const response = await axios.post('http://academic-willm.de/quiz/explain-answer', {
            quizId: quiz.value.quiz_id,
            questionId: currentQuestion.value.question_id,
...
const completeQuiz = async () => {
    try {
        const response = await axios.post('http://academic-willm.de/quiz/complete', {
            quizId: quiz.value.quiz_id,
        });
